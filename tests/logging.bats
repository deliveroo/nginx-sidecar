...
@test "with no reg ex set it logs every request" {
...
@test "with reg ex set to include 200 it logs only 200 requests" {
...
@test "with reg ex set to include 200 and 400 it logs only 200 and 400 requests" {
